...
for (const simpson of simpsons) {
    ...
    div.append(div1,div2,div3,p,img);
    document.body.appendChild(div)
}
...
for (const course of coursesArray) {
    let course1 = document.createElement(`course`);
    ...
    course1.append(title,monthDuration,hourDuration,modules);
    document.body.appendChild(course1);
}
